...
//     {id:3, nombre: "Estudio en escarlata", precio:6900, autor: "Arthur Conan Doyle" },
...
//     Precio: $${book.precio}`;
// alert(mensaje);
// let region = parseInt(prompt(` ${nombrePersona}, ingresa el número de la región donde vives: 1 para Santiago o 2 si vives en otra región del país`));
...
//                 alert(`El libro que buscas es ${nombre} y su precio con iva y envío incluido es $${Math.round(nuevoPrecio)}`);
//             } else if(region ===2){
